...
object Crypto {
     ...
     */
    @VisibleForTesting
    internal val supportedSignatureSchemes: Map<String, SignatureScheme> = listOf(
            RSA_SHA256,
            ECDSA_SECP256K1_SHA256,
            ECDSA_SECP256R1_SHA256,
            EDDSA_ED25519_SHA512,
    ...
    fun findSignatureScheme(schemeCodeName: String): SignatureScheme {
        return supportedSignatureSchemes[schemeCodeName]
    ...
    fun isSupportedSignatureScheme(signatureScheme: SignatureScheme): Boolean {
        return supportedSignatureSchemes[signatureScheme.schemeCodeName] === signatureScheme
    }
